...
public class Dilanda extends Activity {
	...
	if (JawabanUser.equals(JawabanBenar)){
		...
		Intent a=new Intent(getApplicationContext(),Tantangan.class);
		startActivity(a);
		}else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.dilanda, menu);
		return true;
	}
