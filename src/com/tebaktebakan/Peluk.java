...
public class Peluk extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_peluk);
		jawabanTxt=(EditText)findViewById(R.id.editText1);
		jawabanTxt.setFilters(new InputFilter[] {new InputFilter.AllCaps()});
	}
	public void jawabpeluk(View v){
	String JawabanBenar="PELUKAN KERINDUAN";
	...
	if (JawabanUser.equals(JawabanBenar)){
		...
		Intent a=new Intent(getApplicationContext(),Obat.class);
		startActivity(a);
		}else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.peluk, menu);
		return true;
	}
