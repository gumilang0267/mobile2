...
public class Upil extends Activity {
	...
	if (JawabanUser.equals(JawabanBenar)){
		...
		Intent a=new Intent(getApplicationContext(),Minta.class);
		startActivity(a);
		}else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.upil, menu);
		return true;
	}
